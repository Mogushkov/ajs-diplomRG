...
export default class GameController {
  ...
  checkWin() {
    if (this.levelGame === 4 && this.botTeam.members.size === 0) {
      ...
      GamePlay.showMessage(`Поздравляю, Вы выиграли!!! SCORE ${this.points}, MAX SCORE ${Math.max(this.pointsAll)}`);
      this.levelGame += 1;
    }
    ...
    if (this.userTeam.members.size === 0) {
      ...
      GamePlay.showMessage(`Вы проиграли! SCORE ${this.points}, MAX SCORE ${Math.max(this.pointsAll)}`);
    }
  }
